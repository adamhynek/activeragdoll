...
namespace Config {
    struct Options {
        ...
        float grabbedActorMovementLateralStartAngleNoStrafe = 0.05f;
        float grabbedActorMovementLateralStopAngleNoStrafe = 0.02f;
        float grabbedActorMovementStartOffsetNoStrafe = 5.f;
        float grabbedActorMovementStopOffsetNoStrafe = 1.f;
        float grabbedActorMovementNoStrafeMinAngle = 0.001f;
        float grabbedActorMovementHeadingSpeedNoStrafe = 2.f;
        float grabbedActorMovementPlayerDirectionHeadingSpeed = 2.f;
        float grabbedActorMovementMoveSpeedNoStrafe = 100.f;
        float grabbedActorMovementLateralPlayerMovementInfluence = 0.1f;
