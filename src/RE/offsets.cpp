...
RelocAddr<_bhkWorld_RemoveEntity> bhkWorld_RemoveEntity(0xDFAD80);
...
RelocAddr<_SetNiMatrixFromNiQuaternion> SetNiMatrixFromNiQuaternion(0x1E0510);
...
RelocAddr<_BSAnimationGraphManager_RemoveNonRagdollRigidBodiesFromWorld> BSAnimationGraphManager_RemoveNonRagdollRigidBodiesFromWorld(0x61A0E0);
...
RelocAddr<_BShkbAnimationGraph_PreGenerate> BShkbAnimationGraph_PreGenerate(0xB2A190);
RelocAddr<_BShkbAnimationGraph_Generate> BShkbAnimationGraph_Generate(0xB2A9E0);
RelocAddr<_hkaRagdollRigidBodyController_driveToPose> hkaRagdollRigidBodyController_driveToPose(0xB4CFF0);
RelocAddr<_hkaSkeletonMapper_mapPose> hkaSkeletonMapper_mapPose(0xB48AB0);
RelocAddr<_hkaRagdollRigidBodyController_ctor> hkaRagdollRigidBodyController_ctor(0xB4CBC0);
RelocAddr<_hkaRagdollRigidBodyController_dtor> hkaRagdollRigidBodyController_dtor(0xB4CEE0);
RelocAddr<_hkaRagdollRigidBodyController_reinitialize> hkaRagdollRigidBodyController_reinitialize(0xB4D220);
...
RelocAddr<_MapPoseWorldSpaceToPoseModelSpace> MapPoseWorldSpaceToPoseModelSpace(0xB4D5A0);
RelocAddr<_MapPoseModelSpaceToPoseLocalSpace> MapPoseModelSpaceToPoseLocalSpace(0xB4D420);
RelocAddr<_MapPoseWorldSpaceToPoseLocalSpace> MapPoseWorldSpaceToPoseLocalSpace(0xB4D940);
...
RelocAddr<_hkpWorld_addEntityListener> hkpWorld_addEntityListener(0xAB4F80);
RelocAddr<_hkpWorld_removeEntityListener> hkpWorld_removeEntityListener(0xAB4FE0);
...
RelocAddr<_ActorProcess_SetMovementDirectionEulerZ> ActorProcess_SetMovementDirectionEulerZ(0x686480);
RelocAddr<_ActorProcess_SetMovementDirectionEulerX> ActorProcess_SetMovementDirectionEulerX(0x6864C0);
RelocAddr<_ActorProcess_SetMovementDirectionEulerY> ActorProcess_SetMovementDirectionEulerY(0x686500);
